...
///
/// Responsible for
///       1. Making API call to get all videos for a specific sub category
///       2. converting json map to actual data {object}
///       3. converting actual data {object} to json map
///
/// Represent a single [SubCategoryAllVideosModel] data object
/// that contains all videos of a specific subcategory
...
class SubCategoryAllVideosModel {
  ...
  /// This method call an api using [HttpHelper] class to get all video
