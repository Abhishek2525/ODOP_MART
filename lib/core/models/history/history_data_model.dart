...
///
/// Represent a single [HistoryDataModel] data and helps to serialize and
/// deserialize data and allow Use History Related data in app conveniently
class HistoryDataModel {
  BaseData data;

  HistoryDataModel({this.data});
  ...
  _fromJson(Map<String, dynamic> json) {
    if (this.data?.data != null) {
      BaseData temp =
          json['data'] != null ? new BaseData.fromJson(json['data']) : null;

      if (temp == null) return;
      if (temp?.data == null) return;

      data.data?.addAll(temp.data);
