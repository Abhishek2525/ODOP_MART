...
///
/// Responsible for
///       1. Making API call to get app settings informations
///       2. converting json map to actual data {object}
///       3. converting actual data {object} to json map
///
/// Represent a single [SettingsModel] data object
/// that contains all information of this application settings information
/// like {privacy policy} {terms of uses} {cookie policy} etc,
...
class SettingsModel {
  ...
  /// This method call an api by using [HttpHelper] class
  /// and get apps setting information from the server
  Future<void> callApi() async {
    try {
      Map<String, dynamic> res = await HttpHelper.get(AppUrls.settingsUrl);
      if (res == null) return;
      if (res.isEmpty) return;
      print('settings data = $res}');
      //  print(res);
      this._fromJson(res);
    } catch (e) {}
  }
