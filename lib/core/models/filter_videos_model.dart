...
/// A Data Model Class
///
/// Mainly responsible for getting filtering video
///
/// Responsible for
///       1. Making API call
...
///
/// Represent a single [FilterVideosModel] data that make a network call
/// based on filtered data and get a filtered video list from server.
class FilterVideosModel {
  ...
  /// Call filter API based on filtered data
  Future<void> callApi(
      {int totalLike,
      String time,
    ...
    String url = AppUrls.filterVideoUrl(
        totalLike: totalLike,
        time: time,
        resolutions: resolutions,
        categoryIds: categoryIds,
        subCategoryIds: subCategoryIds);
    Map<String, dynamic> res = await HttpHelper.get(url);
    if (res == null) return;
