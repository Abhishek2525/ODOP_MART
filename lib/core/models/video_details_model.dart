...
///
/// Responsible for
///       1. Making API call to get a specific video details by video ID
///       2. converting json map to actual data {object}
///       3. converting actual data {object} to json map
///
/// Represent a single [VideoDetailsModel] data object
/// that contains detailed information of a Video[Data]
class VideoDetailsModel {
  ...
  /// to get a specific video by video id[id] from server
