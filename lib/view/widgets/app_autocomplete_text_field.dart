...
class AppAutoCompleteTextField<T> extends StatefulWidget {
  ...
  final GlobalKey<AppAutoCompleteTextFieldState<T>> key;
  ...
  @override
  State<StatefulWidget> createState() => new AppAutoCompleteTextFieldState<T>(
      suggestions,
      textChanged,
      textSubmitted,
      onFocusChanged,
...
class AppAutoCompleteTextFieldState<T> extends State<AppAutoCompleteTextField> {
...
class SimpleAutoCompleteTextField extends AppAutoCompleteTextField<String> {
  final StringCallback textChanged, textSubmitted;
  final int minLength;
  final ValueSetter<bool> onFocusChanged;
  final TextEditingController controller;
  ...
  SimpleAutoCompleteTextField(
      ...
      @required GlobalKey<AppAutoCompleteTextFieldState<String>> key,
  ...
  State<StatefulWidget> createState() =>
      new AppAutoCompleteTextFieldState<String>(
        suggestions,
        textChanged,
        textSubmitted,
        onFocusChanged,
